...
public class SDLActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //add edittext and button here
        Button button0 = new Button(this);
        RelativeLayout.LayoutParams layoutPs1 = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        layoutPs1.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
        layoutPs1.addRule(RelativeLayout.ALIGN_PARENT_TOP);
        button0.setText("START");
        button0.setLayoutParams(layoutPs1);
        mLayout.addView(button0);

        final EditText editText0 = new EditText(this);
        RelativeLayout.LayoutParams layoutPs0 = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        layoutPs0.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
        layoutPs0.addRule(RelativeLayout.ALIGN_PARENT_TOP);
        layoutPs0.width = 300;
        editText0.setText("3");
        editText0.setBackgroundColor(0xffffff00);
        editText0.setLayoutParams(layoutPs0);
        mLayout.addView(editText0);
        ...
        button0.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                int tmp = Integer.parseInt(editText0.getText().toString());
                if(tmp > 0 && tmp < 10){
                    CallNativeMethods.changeHanioLevel(tmp);
                }
            }
        });
    }
