...
/**
 * SDLSurface. This is what we draw on, so we need to know when it's
 * created in order to do anything useful.
 * 
...
public class SDLSurface extends SurfaceView
	...
	public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
		...
		/*
		 * If the surface has been previously destroyed by
		 * onNativeSurfaceDestroyed, recreate it here
		 */
